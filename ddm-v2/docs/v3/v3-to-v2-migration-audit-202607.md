...
> **2026-07-14 更新**：本報告觸發的修復已全部落地——P0 白屏/合約（5097f31）、SIMO ADR-020（c7d5eb2）、測試隔離（17661cc）、**IA 重構三階段 ADR-021**（Phase 1 側欄收斂 7ff0953、Phase 2 工作台 v3 單頁流 8cd082e、Phase 3 案件情境頁＋Bar 去全域化 d5eda54）。v2 資訊架構已對齊 v3 母版（側欄 7+2、單頁建模流、案件情境編輯）。剩餘 backlog 見 §6 P3 與 ADR-021。
